...
public class CurrentLocation extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapClickListener {
    ...
    private void getCityName(double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses != null && addresses.size() > 0) {
                ...
                // HercityName' contains the name of the city
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        this.googleMap = googleMap;
         if(i.getStringExtra("typemodel").equals("update")){
             LatLng latLng = new LatLng(i.getDoubleExtra("latitude",0), i.getDoubleExtra("longitude",0));
